...
//				$item['filesize'] = serviceHelper::size_kb ($item['filesize']);		//To Fix Column Sort Issue
	...
	public function update_document_type($params)
	{
		$kt =& $this->KT;
		$document_id = (int) $params['document_id'];
		if ($document_id > 0) {
	 ...
	 */
	public function download_document($params, $returnResult = false)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
	 ...
	 *
	 */
	public function checkout_document($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
	 ...
	 * @param array $params
	 */
	public function checkin_document($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
	 ...
	 */
	public function add_document_with_metadata($arr)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
	...
	public function create_empty_upload_file($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
	...
	public function get_all_client_policies()
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$config = KTConfig::getSingleton();
		$this->addDebug ('KTConfig Singleton', $config);
	...
	public function get_all_explorer_policies()
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$config = KTConfig::getSingleton();
		$this->addDebug ('KTConfig Singleton', $config);
	...
	public function delete_document($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$session_id = $params['session_id'];
		$document_id = $params['document_id'];
	...
	public function get_client_policy($arr)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
...
Fatal error:  Cannot unset string offsets in on line 981
	...
	public function check_document_title($arr)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function cancel_checkout($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function get_transaction_history($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function is_latest_version($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function copydocument($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function movedocument($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt = $this->KT;
	...
	public function copyfolder($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function movefolder($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function candeletefolder($arr)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function get_all_files($arr)
	{
		$kt =& $this->KT;
	...
	*/
	public function get_max_fileupload_size()
	{
	 ...
	 */
	public function get_folder_path($arr)
	{
		$kt=&$this->KT;
	 ...
	 */
	public function interpret_folder_path($params)
	{
	...
	public function is_document_deleted($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function is_folder_deleted($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
	...
	public function is_item_deleted($params)
	{
		if ($params['type'] == 'F') {
	...
	public function is_items_deleted($params)
	{
	...
	public function document_has_instantview($params)
	{
		$this->logTrace((__METHOD__.'('.__FILE__.' '.__LINE__.')'),'Enter Function');
		$kt =& $this->KT;
	...
	public function get_cond_metadata_rules()
	{
		$kt =& $this->KT;

...
class ManageConditionalDispatcher extends KTAdminDispatcher {
    ...
    function ManageConditionalDispatcher() {
        ...
        $this->aBreadcrumbs[] = array('url' => KTUtil::ktLink('/settings.php','contentSetup'), 'name' => _kt('Document Metadata and Workflow Configuration'));
        $this->aBreadcrumbs[] = array('url' => KTUtil::ktLink('/settings.php','contentSetup/fieldmanagement'), 'name' => _kt('Document Field Management'));
    ...
    function do_editFieldset() {
        ...
        $this->aBreadcrumbs[] = array(
            'url' => KTUtil::ktLink('settings.php','contentSetup/fieldmanagement','action=edit&fFieldsetId=' . $oFieldset->getId()),
            'name' => $oFieldset->getName()
        );
        $this->aBreadcrumbs[] = array(
            'url' => KTUtil::ktLink('settings.php','contentSetup/fieldmanagement','action=manageConditional&fFieldsetId=' . $oFieldset->getId()),

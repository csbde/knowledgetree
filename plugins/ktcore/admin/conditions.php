        ...
        if (!PEAR::isError($aPermissionObjects) && !empty($aPermissionObjects)) {
            ...
            foreach($aPermissionObjects as $iPermObjectId) {
                ...
                if ($res === false) {
                    ...
                    $this->errorRedirectToMain(_kt('An error occurred while deleting the dynamic condition'));
                    exit;
                }
            }
        }
    ...
    function do_updateSearch() {
        ...
        if (!PEAR::isError($aPermissionObjects) && !empty($aPermissionObjects)) {
            ...
            foreach($aPermissionObjects as $iPermObjectId) {
                ...
                if ($res === false) {
                    $this->rollbackTransaction();
                    $this->errorRedirectToMain(_kt('An error occurred while saving the dynamic condition'));
                    exit;
                }
            }
        }

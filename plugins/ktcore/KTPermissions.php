...
class KTRoleAllocationPlugin extends KTFolderAction {
    ...
    function do_editRoleUsers() {
        ...
        $jsonWidget = KTJSONLookupWidget::getUserSearchWidget($label, 'role', 'users', $members);
    ...
    function do_editRoleGroups() {
        ...
        $jsonWidget = KTJSONLookupWidget::getGroupSelectorWidget($label, 'role', 'groups', $members, $options);

...
class KTLDAPBaseAuthenticationProvider extends KTAuthenticationProvider {
    ...
    function _do_editUserFromSource() {
        ...
        $fields[] =  new KTStringWidget(_kt('Username'), sprintf(_kt('The username the user will enter to gain access to %s.  e.g. jsmith'), APP_NAME), 'ldap_username', $sUserName, $this->oPage, true);

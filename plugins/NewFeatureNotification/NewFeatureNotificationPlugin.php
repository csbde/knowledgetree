...
class NewFeatureNotificationPlugin extends KTPlugin {
...
$oPluginRegistry->registerPlugin('NewFeatureNotificationPlugin', 'new.feature.notification.plugin', __FILE__);

...
require_once('datetime_view.php');
...
class KTDateTime
{
    ...
    public function __construct() {
    	$this->datetime_views = new datetime_view();
    }
	...
	public function renderTimezones()
	{
		$country = isset($_REQUEST['country']) ? $_REQUEST['country'] : '';
		if($country == '') return ;
		echo $this->datetime_views->renderTimezones('', $country);
	}

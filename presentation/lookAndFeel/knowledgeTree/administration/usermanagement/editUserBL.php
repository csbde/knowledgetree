...
if (checkSession()) {
	...
	$oPatternCustom = & new PatternCustom();		
	 ...
	 if (isset($fUserID)){		
		...
		$main->setFormAction("$default->rootUrl/presentation/lookAndFeel/knowledgeTree/store.php?fReturnURL=" . urlencode("$default->rootUrl/control.php?action=editUserSuccess"));		

...
if (checkSession()) {
	...
	if (isset($fFromCreate)) {
		...
		$main->setFormAction("$default->owl_root_url/presentation/lookAndFeel/knowledgeTree/store.php?fReturnURL=" . urlencode("$default->owl_root_url/control.php?action=editRoleSuccess"));		
	}/*	

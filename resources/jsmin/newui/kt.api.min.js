...
c,a,false,d,this.cacheTimeout)};this.inviteUsers=function(b,a,d,c,e,f){var g={};g.addresses=b;g.group=a;g.userType=d;g.sharedData=c;if(e===true)return ktjapi.retrieve("siteapi.inviteUsers",g,200);else ktjapi.callMethod("siteapi.inviteUsers",g,e,false,f,200)};this.shareUsers=function(b,a,d,c,e){var f={};f.addresses=b;f.userType=a;f.sharedData=d;if(c===true)return ktjapi.retrieve("siteapi.inviteUsers",f,200);else ktjapi.callMethod("siteapi.inviteUsers",f,c,false,e,200)};this.isShared=function(b,a){var d=
{};if(b===true)return ktjapi.retrieve("siteapi.hasWrite",d,this.cacheTimeout);else ktjapi.callMethod("siteapi.hasWrite",d,b,false,a,this.cacheTimeout)};this.getUserType=function(){params={};return ktjapi.retrieve("siteapi.getUserType",params,3E4).data.usertype};this.preload=function(b,a,d){for(var c=0;c<b.length;++c)typeof d!="undefined"&&d?kt.eventhandler.register(kt.api.preloadFragment,b[c],"fragment"):kt.api.preloadFragment(b[c]);for(c=0;c<a.length;++c)typeof d!="undefined"&&d?kt.eventhandler.register(kt.api.preloadExecutable,
a[c],"exec"):kt.api.preloadExecutable(a[c])};this.preloadFragment=function(b,a){kt.lib.Object.is_object(a)||(a={});a=kt.lib.Object.extend({name:b},a);ktjapi.callMethod("template.getFragment",a,function(){},false,function(){},3E4,1E4)};this.preloadExecutable=function(b,a){kt.lib.Object.is_object(a)||(a={});if(typeof a.data=="undefined")a=kt.lib.Object.extend({data:"undefined"},a);a=kt.lib.Object.extend({name:b},a);ktjapi.callMethod("template.execFragment",a,function(){},false,function(){},3E4,1E4)};
this.getFragment=function(b,a){kt.lib.Object.is_object(a)||(a={});a=kt.lib.Object.extend({name:b},a);return ktjapi.retrieve("template.getFragment",a,3E4).data.fragment};this.parseFragment=function(b,a){var d={};d.name=b;d.data=a;ret=ktjapi.retrieve("template.parseFragment",d,3E4);return ret.data.parsed};this.execFragment=function(b,a){var d={};d.name=b;d.data=a;ret=ktjapi.retrieve("template.execFragment",d,3E4);return ret.data.fragment}};

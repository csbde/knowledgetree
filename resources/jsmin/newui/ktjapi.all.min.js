...
a)};this.getDataSource=function(a,e,f,h){return this.getDataSourceDetail(a,e,f,h).url};this.getDataSourceDetail=function(a,e,f,h){h=h?true:false;f=false;a=(""+a).split(/\./);return this.createURL(this.createPackage(a[0],a[1],e),f,!h)};this.retrieve=function(a,e,f,h){var k;this.callMethod(a,e,function(l){k=l},true,function(){},f,h);return k};this.callMethod=function(a,e,f,h,k,l,u){a=(""+a).split(/\./);e=this.createPackage(a[0],a[1],e);if(typeof l!=="undefined"){l+=0;if(l>0)e.request.expires=(new Date).getTime()+

...
class Migrater {
	...
	*/
	...
	/**
	* Order in which steps have to be migrateed
	*
	* @author KnowledgeTree Team
	* @access protected
	* @var array string
	...
	*/
	...
	/**
	* Checks if first step of migrateer
	*
	* @author KnowledgeTree Team
	* @param none
	* @access private
	...
	*/
    private function _migrateHelper($className) {
    	...
    	if($class) { // Check if class Exists
	    	if($class->runMigrate()) { // Check if step needs to be migrateed
	...
	*/
    ...
    private function loadNeeded() {
    	...
    	if(isset($_POST['Next'])) {
    		$this->migrateerAction = 'next';
    		$this->response = 'next';
    	} elseif (isset($_POST['Previous'])) {
    		$this->migrateerAction = 'previous';
    		$this->response = 'previous';
   	  	} elseif (isset($_POST['Confirm'])) {
   	  		$this->migrateerAction = 'confirm';
    		$this->response = 'next';
    	} elseif (isset($_POST['Migrate'])) {
    		$this->migrateerAction = 'migrate';
    		$this->response = 'next';
    	} elseif (isset($_POST['Edit'])) {
    		$this->migrateerAction = 'edit';
    		$this->response = 'next';
    	} else {
    		$this->response = '';
    		$this->migrateerAction = '';
    	}
    }
	...
	*/
	...
	/**
	* Display errors that are not allowing the migrateer to operate
	*
	* @author KnowledgeTree Team
	* @param none
	* @access public

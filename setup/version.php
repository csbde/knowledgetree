...
if(isset($_POST['excludefilter'])){ //POST Received
	...
	$snapshot=chunk_split(base64_encode(json_encode($snapshot)));
...
<title>KnowledgeTree System Versions</title>
<link href="../resources/css/newui/version.css" rel="stylesheet" type="text/css" />
<script>
/*!
...
ver=new function(){
	...
	this.collapseBox.expand=function(self){
		$('.body',$(self).parent()).show();
	};

	this.collapseBox.collapse=function(self){
		$('.body',$(self).parent()).hide();
	};

	this.collapseBox.toggle=function(self){
		$($(self).parent()[0]).toggleClass('collapsed');
	}
}
</script>
</head>

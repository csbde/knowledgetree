	...
	<div id="step_content_configuration">
		...
		?>
			<tr>
				...
				<td width="200px"><?php echo $path['name']; ?>:</td>
				<td width="200px"><?php echo $path['path']; ?></td>
	    		<?php if(isset($path['msg'])) {	?>
	    			<td class="error"> <?php echo $path['msg']; ?> </td>
	    			<td width="100px"><a href="javascript:this.location.reload();" class="refresh">Refresh</a></td>
	    		<?php } ?>
			</tr>
		<?php
		    }

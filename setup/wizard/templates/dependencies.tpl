<form action="index.php?step_name=dependencies" method="post">
	...
	<div id="step_content_dependencies">
		...
		<?php } ?>
		<p class="description">
			The extensions shown in red below are required for KnowledgeTree to run optimally. <br/>Items shown in yellow are optional, but recommended.
		</p>

...
(164,'func*3.5.2*1*dropForeignKeys','Recreate db integrity: Drop foreign keys on the database','2007-11-21 00:00:00',1,'upgrade*3.5.2*99*upgrade3.5.2'),
(165,'func*3.5.2*2*dropPrimaryKeys','Recreate db integrity:Drop primary keys on the database','2007-11-21 00:00:00',1,'upgrade*3.5.2*99*upgrade3.5.2'),
(166,'func*3.5.2*3*dropIndexes','Recreate db integrity:Drop indexes on the database','2007-11-21 00:00:00',1,'upgrade*3.5.2*99*upgrade3.5.2'),

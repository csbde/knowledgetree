...
(139,'sql*3.5.0*0*3.5.0/admin_version_path_update.sql','Update Admin Version Plugin Path','2007-08-28 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(140,'sql*3.5.0*0*3.5.0/saved_searches.sql','Database upgrade to version 3.5.0: Saved searches','2007-09-25 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(141,'sql*3.5.0*0*3.5.0/index_files.sql','Database upgrade to version 3.5.0: Index files','2007-09-25 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(142,'sql*3.5.0*0*3.5.0/search_ranking.sql','Database upgrade to version 3.5.0: Search ranking','2007-09-25 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(143,'sql*3.5.0*0*3.5.0/document_checkout.sql','Database upgrade to version 3.5.0: Document checkout','2007-09-25 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(144,'func*3.5.0*0*cleanupOldKTAdminVersionNotifier','Cleanup any old files from the old KTAdminVersionNotifier','2007-09-25 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(145,'upgrade*3.5.0*99*upgrade3.5.0','Upgrade from version 3.4.0 to 3.5.0','2007-09-25 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(146,'sql*3.5.0*0*3.5.0/folder_descendants.sql','Database upgrade to version 3.5.0: Folder descendants','2007-10-11 17:41:32',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(147,'sql*3.5.0*0*3.5.0/relation_friendly.sql','Database upgrade to version 3.5.0: Relation friendly','2007-10-11 17:41:33',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(148,'sql*3.5.0*0*3.5.0/plugin_rss_engine.sql','Database upgrade to version 3.5.0: Plugin rss engine','2007-10-11 17:41:33',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(149,'sql*3.5.0*0*3.5.0/document_transaction_type.sql','Database upgrade to version 3.5.0: Document transaction type','2007-10-11 17:41:33',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(150,'sql*3.5.0*0*3.5.0/scheduler_tables.sql','Database upgrade to version 3.5.0: Scheduler tables','2007-10-23 15:40:56',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(151,'func*3.5.0*0*registerIndexingTasks','Register the required indexing background tasks','2007-10-23 15:40:56',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(152,'func*3.5.0*0*updateConfigFile35','Update the config.ini file for 3.5','2007-10-23 15:40:56',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(153,'sql*3.5.0*0*3.5.0/mime_types.sql','Database upgrade to version 3.5.0: Mime types','2007-10-23 15:40:58',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(154,'upgrade*3.5.0*99*upgrade3.5.0','Upgrade from version 3.4.5 to 3.5.0','2007-11-21 00:00:00',1,'upgrade*3.5.0*99*upgrade3.5.0'),
(155,'sql*3.5.1*0*3.5.1/indexing_tasks_registration.sql','Register indexing tasks with the scheduler.','2007-11-21 00:00:00',1,'upgrade*3.5.1*99*upgrade3.5.1'),

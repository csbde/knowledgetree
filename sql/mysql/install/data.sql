...
(50, 'search', 'Search Base Path', 'Path to search and indexing libraries', 'searchBasePath', 'default', '${fileSystemRoot}/search2', '', NULL, 1),
(51, 'search', 'Fields Path', 'Path to search and indexing fields', 'fieldsPath', 'default', '${searchBasePath}/search/fields', '', NULL, 1),
(52, 'search', 'Results Display Format', 'The format in which to display the results options are searchengine or browseview defaults to searchengine.', 'resultsDisplayFormat', 'default', 'searchengine', 'dropdown', 'a:1:{s:7:"options";a:2:{i:0;a:2:{s:5:"label";s:19:"Search Engine Style";s:5:"value";s:12:"searchengine";}i:1;a:2:{s:5:"label";s:17:"Browse View Style";s:5:"value";s:10:"browseview";}}}', 1),
(53, 'search', 'Results Per Page', 'The number of results per page, defaults to 25', 'resultsPerPage', 'default', '25', 'numeric_string', NULL, 1),
(54, 'search', 'Date Format', 'The date format used when making queries using widgets, defaults to Y-m-d', 'dateFormat', 'default', 'Y-m-d', '', NULL, 1),
(55, 'browse', 'Preview Activation', 'The document info box / preview is activated by mousing over or clicking on the icon. Options: mouse-over (default) or onclick.', 'previewActivation', 'default', 'onclick', 'dropdown', 'a:1:{s:7:"options";a:2:{i:0;a:2:{s:5:"label";s:10:"Mouse Over";s:5:"value";s:10:"mouse-over";}i:1;a:2:{s:5:"label";s:8:"On Click";s:5:"value";s:7:"onclick";}}}', 1),
(56, 'indexer', 'Core Class', 'The core indexing class. Choices: JavaXMLRPCLuceneIndexer or PHPLuceneIndexer.', 'coreClass', 'default', 'JavaXMLRPCLuceneIndexer', '', NULL, 1),
(57, 'indexer', 'Batch Documents', 'The number of documents to be indexed in a cron session, defaults to 20.', 'batchDocuments', 'default', '20', 'numeric_string', 'a:3:{s:9:"increment";i:10;s:7:"minimum";i:20;s:7:"maximum";i:200;}', 1),
(58, 'indexer', 'Batch Migrate Documents', 'The number of documents to be migrated in a cron session, defaults to 500.', 'batchMigrateDocuments', 'default', '500', 'numeric_string', NULL, 1),
(59, 'indexer', 'Indexing Base Path', 'Path to indexing engine', 'indexingBasePath', 'default', '${searchBasePath}/indexing', '', NULL, 1),
(60, 'indexer', 'Lucene Directory', 'The location of the lucene indexes.', 'luceneDirectory', 'default', '${varDirectory}/indexes', '', NULL, 1),
(61, 'indexer', 'Extractor Path', 'Path to text extractors', 'extractorPath', 'default', '${indexingBasePath}/extractors', '', NULL, 1),
(62, 'indexer', 'Extractor Hook Path', 'Path to extractor hooks', 'extractorHookPath', 'default', '${indexingBasePath}/extractorHooks', '', NULL, 1),
(63, 'indexer', 'Java Lucene URL', 'The url for the Java Lucene Server. This should match up the the Lucene Server configuration. Defaults to http://127.0.0.1:8875', 'javaLuceneURL', 'default', 'http://127.0.0.1:8875', '', NULL, 1),
(64, 'openoffice', 'Host', 'The host on which open office is installed. Defaults to 127.0.0.1', 'host', 'default', '127.0.0.1', '', NULL, 1),
(65, 'openoffice', 'Port', 'The port on which open office is listening. Defaults to 8100', 'port', 'default', '8100', 'numeric_string', NULL, 1),
(66, 'webservice', 'Upload Directory', 'Directory to which all uploads via webservices are persisted before moving into the repository.', 'uploadDirectory', 'default', '${varDirectory}/uploads', '', NULL, 1),
(67, 'webservice', 'Download Url', 'Url which is sent to clients via web service calls so they can then download file via HTTP GET.', 'downloadUrl', 'default', '${rootUrl}/ktwebservice/download.php', '', NULL, 1),
(68, 'webservice', 'Upload Expiry', 'Period indicating how long a file should be retained in the uploads directory.', 'uploadExpiry', 'default', '30', 'numeric_string', 'a:1:{s:6:"append";s:7:"seconds";}', 1),
(69, 'webservice', 'Download Expiry', 'Period indicating how long a download link will be available.', 'downloadExpiry', 'default', '30', 'numeric_string', 'a:1:{s:6:"append";s:7:"seconds";}', 1),
(70, 'webservice', 'Random Key Text', 'Random text used to construct a hash. This can be customised on installations so there is less chance of overlap between installations.', 'randomKeyText', 'default', 'bkdfjhg23yskjdhf2iu', '', NULL, 1),
(71, 'webservice', 'Validate Session Count', 'Validating session counts can interfere with access. It is best to leave this disabled, unless very strict access is required.', 'validateSessionCount', 'false', 'false', 'boolean', NULL, 1),
(72, 'webservice', 'Use Default Document Type If Invalid', 'If the document type is invalid when adding a document, we can be tollerant and just default to the Default document type.', 'useDefaultDocumentTypeIfInvalid', 'true', 'true', 'boolean', NULL, 1),
(73, 'webservice', 'Debug', 'The web service debugging if the logLevel is set to DEBUG. We can set the value to 4 or 5 to get more verbose web service logging. Level 4 logs the name of functions being accessed. Level 5 logs the SOAP XML requests and responses.', 'debug', 'false', 'false', 'boolean', NULL, 1),
(74, 'DiskUsage', 'Warning Threshold', 'When free space in a mount point is less than this percentage, the disk usage dashlet will highlight the mount in ORANGE.', 'warningThreshold', '10', '10', 'numeric_string', 'a:1:{s:6:"append";s:1:"%";}', 1),
(75, 'DiskUsage', 'Urgent Threshold', 'When free space in a mount point is less than this percentage, the disk usage dashlet will highlight the mount in RED.', 'urgentThreshold', '5', '5', 'numeric_string', 'a:1:{s:6:"append";s:1:"%";}', 1),
(76, 'KnowledgeTree', 'Use AJAX Dashboard', 'User AJAX dashboard with rounded corners and draggable dashlets.', 'useNewDashboard', 'true', 'true', 'boolean', NULL, 1),
(77, 'i18n', 'Default Language', 'Default language for the interface.', 'defaultLanguage', 'default', 'en', 'string', NULL, 1),
(78, 'CustomErrorMessages', 'Custom Error Messages', 'Turn custom error messages on or off here', 'customerrormessages', 'default', 'on', 'radio', 'a:1:{s:7:"options";a:2:{i:0;s:2:"on";i:1;s:3:"off";}}', 1),
(79, 'CustomErrorMessages', 'Custom Error Page Path', 'Name or url of custom error page.', 'customerrorpagepath', 'default', 'customerrorpage.php', '', NULL, 1),
(80, 'CustomErrorMessages', 'Custom Error Handler', 'Turn custom error handler on or off', 'customerrorhandler', 'default', 'on', 'radio', 'a:1:{s:7:"options";a:2:{i:0;s:2:"on";i:1;s:3:"off";}}', 1),
(81, 'ui', 'Skinning Enabled', 'Enable Skinning', 'morphEnabled', 'default', 'false', 'boolean', NULL, 1),
(82, 'ui', 'Default Skin', 'Enter a default skin', 'morphTo', 'default', 'blue', '', NULL, 1),
(83, 'KnowledgeTree', 'Log Level', 'Choice: INFO or DEBUG', 'logLevel', 'default', 'INFO', 'dropdown', 'a:1:{s:7:"options";a:4:{i:0;a:2:{s:5:"label";s:4:"INFO";s:5:"value";s:4:"INFO";}i:1;a:2:{s:5:"label";s:4:"WARN";s:5:"value";s:4:"WARN";}i:2;a:2:{s:5:"label";s:5:"ERROR";s:5:"value";s:5:"ERROR";}i:3;a:2:{s:5:"label";s:5:"DEBUG";s:5:"value";s:5:"DEBUG";}}}', 1),
(84, 'storage', 'Manager', 'KnowledgeTree Storage manager. Default is KTOnDiskHashedStorageManager.', 'manager', 'default', 'KTOnDiskHashedStorageManager', '', NULL, 1),
(85, 'ui', 'ieGIF', 'Use the additional IE specific GIF theme overrides. Using this means that arbitrary theme packs may not work without having GIF versions available. ', 'ieGIF', 'false', 'true', 'boolean', NULL, 1),
(86, 'ui', 'Automatic Refresh', 'Set to true to automatically refresh the page after the session would have expired.', 'automaticRefresh', 'default', 'false', 'boolean', NULL, 1),
(87, 'ui', 'dot', 'Path to dot binary', 'dot', 'dot', 'dot', '', NULL, 1),
(88, 'tweaks', 'Php Error Log File', 'If you want to enable PHP error logging to the log/php_error_log file, change this setting to true.', 'phpErrorLogFile', 'default', 'false', 'boolean', NULL, 1),
(89, 'urls', 'Log Directory', 'Path to log directory', 'logDirectory', 'default', '${varDirectory}/log', '', NULL, 1),
(90, 'urls', 'UI Directory', 'Path to UI directory', 'uiDirectory', 'default', '${fileSystemRoot}/presentation/lookAndFeel/knowledgeTree', '', NULL, 1),
(91, 'urls', 'Temp Directory', 'Path to temp directory', 'tmpDirectory', 'default', '${varDirectory}/tmp', '', NULL, 1),

...
browse view.', 'titleCharLength', 'default', '40', 'numeric_string', NULL, 1),
...
('tweaks', 'Update Document Version (Content) on Editing Metadata', 'The document version is equivalent to the document content version. When set to
true the document version will be increased when the document metadata is updated.', 'updateContentVersion', 'default', 'false', 'boolean', NULL, 1);
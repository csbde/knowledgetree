...
alter table document_transactions change filename filename mediumtext NOT NULL default '';
alter table document_transactions change comment comment mediumtext NOT NULL default '';
